  ...
  return (
    ...
    >
      ...
      <motion.a
        ...
        className="group relative mt-28 flex size-14 items-center justify-center rounded-full bg-sun text-ink shadow-[0_14px_40px_-10px_rgba(255,206,0,0.85)] ring-2 ring-ink transition-transform hover:scale-110 md:mt-36"
      >
        {/* pulsing halo */}
